...
vTcl:font:add_font \
    "-family {Comic Sans MS} -size 12 -weight bold -slant roman -underline 0 -overstrike 0" \
    user \
    vTcl:font13
#################################
#LIBRARY PROCEDURES
...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 602x447+997+244
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button $site_4_0.but44 \
        ...
        -foreground {#000000} -highlightcolor black -text Enter 
    vTcl:DefineAlias "$site_4_0.but44" "Button1" vTcl:WidgetProc "Toplevel1" 1
    bind $site_4_0.but44 <Enter> {
        lambda e: enterbtn(e)
    }
    ...
    ttk::labelframe $site_4_0.tPa45.p1 \
        -text {Pane 1} -width -80 -height 200 
    vTcl:DefineAlias "$site_4_0.tPa45.p1" "TPanedwindow1_p1" vTcl:WidgetProc "Toplevel1" 1
    set site_6_0 $site_4_0.tPa45.p1
    vTcl::widgets::ttk::scrolledtext::CreateCmd $site_6_0.scr74 \
        -background {#d9d9d9} -height 153 -highlightcolor black -width 248 
    vTcl:DefineAlias "$site_6_0.scr74" "Scrolledtext1" vTcl:WidgetProc "Toplevel1" 1

    $site_6_0.scr74.01 configure -background white \
        -font font9 \
        -foreground black \
        -height 3 \
        ...
        -width 10 \
        -wrap none
    place $site_6_0.scr74 \
        -in $site_6_0 -x 10 -y 20 -width 248 -relwidth 0 -height 153 \
    ...
    ttk::labelframe $site_4_0.tPa45.p2 \
        -text {Pane 2} -width 280 -height 200 
    vTcl:DefineAlias "$site_4_0.tPa45.p2" "TPanedwindow1_p2" vTcl:WidgetProc "Toplevel1" 1
    set site_6_1 $site_4_0.tPa45.p2
    message $site_6_1.mes72 \
        -background {#d9d9d9} -foreground {#000000} -highlightcolor black \
        -relief ridge -text Message -width 253 
    vTcl:DefineAlias "$site_6_1.mes72" "Message1" vTcl:WidgetProc "Toplevel1" 1
    place $site_6_1.mes72 \
        -in $site_6_1 -x 10 -y 20 -width 253 -relwidth 0 -height 150 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    checkbutton $site_5_0.che66 \
        -activebackground {#d9d9d9} -background {#d9d9d9} \
        -foreground {#000000} -highlightcolor black -justify left -text Check \
        -variable che66 
    ...
    text $top.tex70 \
        -background black -font $::vTcl(fonts,vTcl:font13,object) \
        -foreground white -height 122 -highlightcolor black \
        -insertbackground black -selectbackground {#c4c4c4} \
        -selectforeground black -state disabled -width 286 -wrap word 
    .top37.tex70 configure -font font13
    .top37.tex70 insert end text
    vTcl:DefineAlias "$top.tex70" "OutputDisplay" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex71 \
        -background black -font $::vTcl(fonts,vTcl:font13,object) \
        -foreground white -height 122 -highlightcolor black \
        -insertbackground black -selectbackground {#c4c4c4} \
        -selectforeground black -state disabled -width 286 -wrap word 
    .top37.tex71 configure -font font13
    .top37.tex71 insert end text
    vTcl:DefineAlias "$top.tex71" "ErrorDisplay" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.pNo41 \
    ...
    place $top.tex70 \
        -in $top -x 20 -y 10 -width 286 -relwidth 0 -height 122 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tex71 \
        -in $top -x 300 -y 10 -width 286 -relwidth 0 -height 122 -relheight 0 \
        -anchor nw -bordermode ignore 
