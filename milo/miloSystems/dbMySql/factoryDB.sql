...
http://www.vspace.com
*********************************************************************
Name: Milo MySQL Default Database
Link: http://www.vspace.com/
Version 1.0
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`milo_defaults` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `users`(`id`, `username`,`email`, `password`) values (1, 'milo', 'milo@vspace.com', itsmemilo);

/*Table structure for table `current_addresses` */
...
/*Data for the table `current_address` */

insert  into `current_addresses`(`id`, `street_address`,`city`, `state`) values (1, '555 default st ','default ','default ');

/*Table structure for table `birth_locations` */

DROP TABLE IF EXISTS `birth_locations`;
...
/*Data for the table `birth_locations` */

insert  into `birth_locations`(`id`, `birth_city`,`birth_state`) values (1, 'default', 'default');
...
CREATE TABLE `profiles` (
   ...
   INDEX `fk_current_add_id_idx` (`current_address_id` ASC),
   INDEX `fk_birt_add_id_idx` (`birth_address_id` ASC),
   CONSTRAINT `fk_current_add_id` FOREIGN KEY (`current_address_id`)
      REFERENCES `current_addresses` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
   CONSTRAINT `fk_birt_add_id` FOREIGN KEY (`birth_address_id`)
      REFERENCES `birth_locations` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
)  ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

/*Data for the table `profiles` */

insert  into `profiles`(`id`, `first_name`,`middle_name`, `last_name`, `age`, `birthdate`, `weight`, `height`, `gender`, `phone_number`, `current_address_id`, `birth_address_id`) values (1, 'default ','default ','default ',1,'12291981',75,57,'male',5555555555,1,1);
...
CREATE TABLE `users_profiles` (
   ...
   CONSTRAINT `fk_profile_id` FOREIGN KEY (`profile_id`) REFERENCES `profiles` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
)  ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `users_profiles` */

insert  into `users_profiles`(`profile_id`, `user_id`) values (1,1);
...
(9, 'SSH', 'Secure shell', 22, 'paramiko, jumpssh');
...
(2,
'greeting2',
'Welcome to the backend of VSpace',
2,
'Second Greeting'),
(3,
'returngreeting1',
...
(4,
'subgreeting1',
'I will be your host for your stay',
4,
'Sub Greeting'),
(5,
'subgreeting2',
'Allow me to check you into the ledger',
5,
'Sub Greeting');
